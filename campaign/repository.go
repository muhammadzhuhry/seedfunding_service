...
func (r *repository) FindAll() ([]Campaign, error) {
	...
	// preload -> load relasi, isi dari querynya dari struct dan args nya sama seperti where
...
func (r *repository) FindByID(ID int) (Campaign, error) {
	...
	// preload -> load relasi, isi dari querynya dari struct
...
func (r *repository) MarkAllImagesAsNonPrimary(campaignID int) (bool, error) {
	...
	// model -> mendapatkan nama tabel berdasarkan interface yg di masukan (alternatif find jika tidak mau ambil data ke db terlebih dahulu)
